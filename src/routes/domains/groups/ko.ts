...
export const ko: TranslationSchema = {
  ...
  assignModalSave: "저장",
  assignModalSearchPlaceholder: "도메인 검색...",
  assignModalFilterAll: "전체 도메인",
  assignModalFilterUnassigned: "그룹 미소속",
  assignModalOtherGroups: "다른 그룹들",
  assignModalAlreadyInGroup: "소속된 그룹",
  assignModalNoDomainsFound: "검색 결과가 없습니다.",
};
